...
impl VarBindSet {
    ...
    pub fn get_int_val (&mut self, name: String) -> Option<&usize> {
        self.int_contents.get(&name)
    }

    //Look up the value of an existing variable
    pub fn get_str_val (&mut self, name: String) -> Option<&String> {
