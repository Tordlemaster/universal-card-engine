use crate::rules::{conditional::{conditional::{ConditionalMode, MultiConditional, TrueConditional}, deck_conditional::{DeckConditional, DeckSuitsComp, DeckSuitsConditional, DeckValsComp, DeckValsConditional}}, deck::{CardAttr, CardSetData}, game::GameWorld, player::Player, routine::{choice_routine::{Choice, ChoiceLimit, ChoicesRoutine}, cond_routine::{CondRoutine, CondRoutineMode}, evaluatables::{DeckVisibilityEvaluatable, EvaluatableString}, iter_routine::ForPlayerRoutine, primitives::{CreateDeckRoutine, CreateSourceDeckRoutine, DealRoutine, StateSwitchRoutine}, routine::SeqRoutine}, state::{State, StateSet}, variable::VarBindSet};

pub fn rummy() -> GameWorld {
            ...
            vec![
                Some(State::new(
                    Box::new(SeqRoutine::new(vec![
                        ...
                        Box::new(CreateSourceDeckRoutine::new(&"Discard pile".to_string(), DeckVisibilityEvaluatable::new(true, true, Vec::new(), Vec::new()))),
                        Box::new(ForPlayerRoutine::new(
                            Box::new(SeqRoutine::new(vec![
                                ...
                                Box::new(DealRoutine::new(&"Draw pile".to_string(), &"[THISPLAYER]'s hand".to_string(), 1))
                            ]))
                        )),
                        Box::new(DealRoutine::new(&"Draw pile".to_string(), &"Discard pile".to_string(), 1)),
                                ...
                                Box::new(ChoicesRoutine::new(
                                    vec![
                                        ...
                                        Choice::new(
                                            ...
                                            CondRoutine::without_cond(
                                                Box::new(DealRoutine::new(&"Discard pile".to_string(), &"[THISPLAYER]'s hand".to_string(), 1)),
                                            )
                                        )
                                    ],
                                        ...
                                        Choice::new(
                                            ...
                                            CondRoutine::new(
                                                ...
                                                Box::new(SeqRoutine::new(vec![
                                                    ...
                                                    Box::new(DealRoutine::new(&"[THISPLAYER]'s hand".to_string(), &"Meld #".to_string(), 3))
                                                ])),
